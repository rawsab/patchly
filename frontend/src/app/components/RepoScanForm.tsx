...
export default function RepoScanForm({ repoUrl, setRepoUrl, loading, handleSubmit }: RepoScanFormProps) {
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-xl flex flex-col items-center justify-center gap-4 mb-8 mx-auto">
      <div className="relative flex w-full items-center">
        ...
        <button
          ...
          style={{ minWidth: 90 }}
        >
          {loading ? <span style={{ letterSpacing: '-0.025em', color: '#1F233A' }}>Scanning...</span> : <><span style={{ letterSpacing: '-0.025em' }}>Scan</span><ArrowRight size={18} /></>}
        </button>
      </div>
    </form>
  );
